...
# C Compiler Flags
CFLAGS=-locilib -L/usr/local/include

# CC Compiler Flags
CCFLAGS=-locilib -L/usr/local/include
CXXFLAGS=-locilib -L/usr/local/include
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/monitoramento

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/monitoramento: ${OBJECTFILES}
...
${OBJECTDIR}/monitoramento.o: monitoramento.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/monitoramento.o monitoramento.c
